...
3. Crushed server can be restarted.  Even after 3 or more servers crushes, as long as some servers are restarted so that 3 servers are running, our system can return to work. 
